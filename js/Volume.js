...
/*十字准线
    function enterVolume() {
        coordsTextVolume.style("display", "inline");
    }

    function outVolume() {
        coordsTextVolume.style("display", "none");
    }

    function moveVolume(coords) {
        coordsTextVolume.text(
            timeAnnotation.format()(coords.xVolume) + ", " + volumeAnnotation.format()(coords.yVolume)
        );
    }
    */